    ...
    @objc(CameraController) class CameraController: NSObject {
        ...
        var imageUseDeviceOrientation = false
    ...
    extension CameraController: AVCaptureFileOutputRecordingDelegate, AVCapturePhotoCaptureDelegate {
        ...
        func grabImage( call: CAPPluginCall ) {
            ...
            imageUseDeviceOrientation = call.getBool("useDeviceOrientation") ?? true
...
//
                ...
                switch currentOrientation {
                    ...
                    case .landscapeRight:
                        if (self.sessionDevicePosition == .front) {
                            tempImage = tempImage.oriented(.downMirrored)
                        } else {
                            tempImage = tempImage.oriented(.up)
                        }
                    case .landscapeLeft:
